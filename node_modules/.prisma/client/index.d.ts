  ...
  */
  ...
  export interface GalaxysDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `id`
     * const galaxysWithIdOnly = await prisma.galaxys.findMany({ select: { id: true } })
     * 
    **/
  ...
  export type PlanetsGetPayload<
    ...
    ? Planets  & {
    [P in TrueKeys<S['include']>]:
        P extends 'galaxyId' ? GalaxysGetPayload<S['include'][P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'galaxyId' ? GalaxysGetPayload<S['select'][P]> | null :  P extends keyof Planets ? Planets[P] : never
  } 
    : Planets
  : Planets
  ...
  export interface PlanetsDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `id`
     * const planetsWithIdOnly = await prisma.planets.findMany({ select: { id: true } })
     * 
    **/
  ...
  export class Prisma__PlanetsClient<T> implements PrismaPromise<T> {
    ...
    galaxyId<T extends GalaxysArgs = {}>(args?: Subset<T, GalaxysArgs>): CheckSelect<T, Prisma__GalaxysClient<Galaxys | null >, Prisma__GalaxysClient<GalaxysGetPayload<T> | null >>;
  ...
  export type PlanetsWhereInput = {
    ...
    description?: StringFilter | string
    size?: DecimalFilter | Decimal | DecimalJsLike | number | string
    galaxyId?: XOR<GalaxysRelationFilter, GalaxysWhereInput> | null
  ...
  export type PlanetsOrderByWithRelationInput = {
    ...
    description?: SortOrder
    size?: SortOrder
    galaxyId?: GalaxysOrderByWithRelationInput
  ...
  export type GalaxysCreateInput = {
    ...
    planets?: PlanetsCreateNestedManyWithoutGalaxyIdInput
  }
  ...
  export type GalaxysUncheckedCreateInput = {
    ...
    color: string
    size: Decimal | DecimalJsLike | number | string
    planets?: PlanetsUncheckedCreateNestedManyWithoutGalaxyIdInput
  }
  ...
  export type GalaxysUpdateInput = {
    ...
    planets?: PlanetsUpdateManyWithoutGalaxyIdInput
  }
  ...
  export type GalaxysUncheckedUpdateInput = {
    ...
    color?: StringFieldUpdateOperationsInput | string
    size?: DecimalFieldUpdateOperationsInput | Decimal | DecimalJsLike | number | string
    planets?: PlanetsUncheckedUpdateManyWithoutGalaxyIdInput
  }
  ...
  export type PlanetsCreateInput = {
    ...
    description: string
    size: Decimal | DecimalJsLike | number | string
    galaxyId?: GalaxysCreateNestedOneWithoutPlanetsInput
  }
  ...
  export type PlanetsUpdateInput = {
    ...
    description?: StringFieldUpdateOperationsInput | string
    size?: DecimalFieldUpdateOperationsInput | Decimal | DecimalJsLike | number | string
    galaxyId?: GalaxysUpdateOneWithoutPlanetsInput
  }
  ...
  export type PlanetsCreateNestedManyWithoutGalaxyIdInput = {
    create?: XOR<Enumerable<PlanetsCreateWithoutGalaxyIdInput>, Enumerable<PlanetsUncheckedCreateWithoutGalaxyIdInput>>
    connectOrCreate?: Enumerable<PlanetsCreateOrConnectWithoutGalaxyIdInput>
    createMany?: PlanetsCreateManyGalaxyIdInputEnvelope
    connect?: Enumerable<PlanetsWhereUniqueInput>
  }

  export type PlanetsUncheckedCreateNestedManyWithoutGalaxyIdInput = {
    create?: XOR<Enumerable<PlanetsCreateWithoutGalaxyIdInput>, Enumerable<PlanetsUncheckedCreateWithoutGalaxyIdInput>>
    connectOrCreate?: Enumerable<PlanetsCreateOrConnectWithoutGalaxyIdInput>
    createMany?: PlanetsCreateManyGalaxyIdInputEnvelope
    connect?: Enumerable<PlanetsWhereUniqueInput>
  ...
  export type PlanetsUpdateManyWithoutGalaxyIdInput = {
    create?: XOR<Enumerable<PlanetsCreateWithoutGalaxyIdInput>, Enumerable<PlanetsUncheckedCreateWithoutGalaxyIdInput>>
    connectOrCreate?: Enumerable<PlanetsCreateOrConnectWithoutGalaxyIdInput>
    upsert?: Enumerable<PlanetsUpsertWithWhereUniqueWithoutGalaxyIdInput>
    createMany?: PlanetsCreateManyGalaxyIdInputEnvelope
    ...
    connect?: Enumerable<PlanetsWhereUniqueInput>
    update?: Enumerable<PlanetsUpdateWithWhereUniqueWithoutGalaxyIdInput>
    updateMany?: Enumerable<PlanetsUpdateManyWithWhereWithoutGalaxyIdInput>
    deleteMany?: Enumerable<PlanetsScalarWhereInput>
  }

  export type PlanetsUncheckedUpdateManyWithoutGalaxyIdInput = {
    create?: XOR<Enumerable<PlanetsCreateWithoutGalaxyIdInput>, Enumerable<PlanetsUncheckedCreateWithoutGalaxyIdInput>>
    connectOrCreate?: Enumerable<PlanetsCreateOrConnectWithoutGalaxyIdInput>
    upsert?: Enumerable<PlanetsUpsertWithWhereUniqueWithoutGalaxyIdInput>
    createMany?: PlanetsCreateManyGalaxyIdInputEnvelope
  ...
  export type PlanetsCreateWithoutGalaxyIdInput = {
    id?: string
    name: string
    description: string
    size: Decimal | DecimalJsLike | number | string
  ...
  export type PlanetsUncheckedCreateWithoutGalaxyIdInput = {
    id?: string
    name: string
    description: string
    size: Decimal | DecimalJsLike | number | string
  ...
  export type PlanetsCreateOrConnectWithoutGalaxyIdInput = {
    where: PlanetsWhereUniqueInput
    create: XOR<PlanetsCreateWithoutGalaxyIdInput, PlanetsUncheckedCreateWithoutGalaxyIdInput>
  }

  export type PlanetsCreateManyGalaxyIdInputEnvelope = {
    data: Enumerable<PlanetsCreateManyGalaxyIdInput>
  }

  export type PlanetsUpsertWithWhereUniqueWithoutGalaxyIdInput = {
    where: PlanetsWhereUniqueInput
    update: XOR<PlanetsUpdateWithoutGalaxyIdInput, PlanetsUncheckedUpdateWithoutGalaxyIdInput>
    create: XOR<PlanetsCreateWithoutGalaxyIdInput, PlanetsUncheckedCreateWithoutGalaxyIdInput>
  }

  export type PlanetsUpdateWithWhereUniqueWithoutGalaxyIdInput = {
    where: PlanetsWhereUniqueInput
    data: XOR<PlanetsUpdateWithoutGalaxyIdInput, PlanetsUncheckedUpdateWithoutGalaxyIdInput>
  }

  export type PlanetsUpdateManyWithWhereWithoutGalaxyIdInput = {
  ...
  export type PlanetsCreateManyGalaxyIdInput = {
    id?: string
    name: string
    description: string
    size: Decimal | DecimalJsLike | number | string
  ...
  export type PlanetsUpdateWithoutGalaxyIdInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    size?: DecimalFieldUpdateOperationsInput | Decimal | DecimalJsLike | number | string
  ...
  export type PlanetsUncheckedUpdateWithoutGalaxyIdInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    size?: DecimalFieldUpdateOperationsInput | Decimal | DecimalJsLike | number | string
